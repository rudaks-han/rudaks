...
$(function() {
	...
	function uploadFile(file)
	{
		...
		$.ajax({
		    ...
		    success: function(data)
		    {
				if (data.success)
		    	{
					$('.attach-result').append('<span style="margin:5px">' + data.fileName + '</span>');
	...
	$('#btn-submit').on('click', function() {
		...
		var inForm = $('#postForm');
		inForm.find('#content').val(sHTML);
		inForm.action = "post-new";
		inForm.submit();
	});
...
// $('.summernote').code(sHTML);
		...
		<div class="col-lg-8">
            <div class="well bs-component">
              ...
              <sf:hidden path="filePath" id="filePath" value="" />
              <sf:hidden path="fileName" id="fileName" value="" />
              <sf:hidden path="fileSize" id="fileSize" value="" />
                <fieldset>
                  ...
                  ">
                    ...
                    <div class="col-lg-10">
                      <sf:input class="form-control" path="username" id="username" placeholder="Name" value="${sessionScope.loginInfo.username}"/>
                    </div>
                  </div>
                  <div class="form-group
                  <s:bind path="email">
                  ...
                  ">
                    ...
                    <div class="col-lg-10">
                      <sf:input class="form-control" path="email" id="email" placeholder="Email" value="${sessionScope.loginInfo.email}"/>
                    </div>
                  </div>
                  <div class="form-group
                  <s:bind path="title">
