...
<head>
    ...
    <meta content="<c:out value="${metaDescription}" escapeXml="true" />" name="description" />
    ...
    <meta content="<c:out value="${pageTitle}" escapeXml="true" />" property="og:title" />
    <meta content="<c:out value="${metaDescription}" escapeXml="true" />" property="og:description" />
    ...
    <meta content="<c:out value="${pageTitle}" escapeXml="true" />" name="twitter:title" />
    <meta content="<c:out value="${metaDescription}" escapeXml="true" />" name="twitter:description" />
